...
class Game:
    ...
    def remove_entity(self, entity_type: str, entity: LivingEntity):
    ...
    def get_entities_list(self, entity_types: list):
        res = []
    ...
    def calculate_dist_entity_by_list(self, entity: LivingEntity, entity_types: list):
    ...
    def return_closest_entity(self, this_entity: LivingEntity, entity_types: list):
        try:
