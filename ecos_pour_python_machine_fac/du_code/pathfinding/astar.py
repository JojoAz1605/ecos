...
class Astar:
    def __init__(self, grid: Grille, start_pos: tuple, end_pos: tuple):
    ...
    def __is_in_list(self, one_node: Node, liste: list):
    ...
    def __update_if_already_in_open_and_with_better_score(self, studied_node: Node, successor: Node):
    ...
    def __get_best_node_in_open(self):
